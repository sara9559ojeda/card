    ...
    <main className="bg-gradient-to-r from-cyan-500 to-blue-600 w-full h-screen flex justify-center items-center">
      <section className=" h-[47%] w-[50%]  ">
        <article className="bg-slate-900 rounded-xl p-10 grid lg:grid-cols-2 grid-cols-1">
          ...
          <p className=" flex">
            <p className="     lg:-ml-44 w-[50%]  lg:pl-12 lg:pr-12 p-2 text-gray-100 font-serif  border rounded-3xl">
            Profile
          </p>
          <p className="flex w-[50%] lg:pl-12 lg:pr-12 p-2 text-gray-900 font-serif bg-slate-200 rounded-3xl">
            Follow
          </p></p>
